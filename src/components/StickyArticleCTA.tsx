...
export default function StickyArticleCTA({ lang = 'en' }: { lang?: 'en' | 'ru' }) {
  ...
  return (
    <div
      ...
      style={{ background: 'linear-gradient(135deg, #101923, #1a2b3d)', animation: 'slide-up-bar 0.3s ease-out', boxShadow: '0 -4px 20px rgba(0,0,0,0.3)' }}
    >
      <div className="mx-auto flex max-w-5xl flex-col items-center gap-3 px-4 py-3 sm:flex-row sm:justify-between">
        ...
        <div className="flex items-center gap-3">
          <a
            ...
            className="shrink-0 rounded-xl px-6 py-2.5 text-sm font-bold text-white transition-all hover:opacity-90"
